...
const BarangMasuk = () => {
    ...
    const [selectedMonth, setSelectedMonth] = useState(''); // '' untuk "Semua Bulan", '1'-'12' untuk bulan spesifik
    ...
    useEffect(() => {
        // Panggil fetchBarangMasuk dengan nilai state saat ini
        fetchBarangMasuk(search, page, selectedMonth, selectedYear);
    ...
    const handleFilterSubmit = () => {
        ...
        setPage(1);
        // fetchBarangMasuk akan otomatis terpanggil karena perubahan `selectedMonth` atau `selectedYear` sudah menjadi dependencies `useEffect`
    };
    ...
    return (
        <div className="d-flex">
            ...
            <div className="container mt-4">
                <h4 className="fw-bold">Data Barang Masuk</h4>
                <p>Manajemen data inventori barang</p>
